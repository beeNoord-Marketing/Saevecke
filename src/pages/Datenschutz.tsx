...
const h2 = 'mt-14 text-2xl font-semibold';
const h3 = 'mt-8 text-xl font-semibold';
const h4 = 'mt-6 text-lg font-semibold';
const p = 'mt-4 text-brand-text';
const ul = 'mt-4 list-disc pl-6 text-brand-text space-y-2';
    ...
    <>
      ...
      <main className="pt-24">
        <Section>
          ...
          <h4 className={h4}>Wofür nutzen wir Ihre Daten?</h4>
          <p className={p}>
          ...
          <h4 className={h4}>Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
          <p className={p}>
          ...
          <h3 className={h3}>Externes Hosting</h3>
          <p className={p}>
            ...
            Hosters / der Hoster gespeichert. Hierbei kann es sich v.
            {' '}a. um IP-Adressen, Kontaktanfragen, Meta- und
          ...
          <p className={p}>
            ...
            {' '}B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die
          ...
          <p className={p}>Wir setzen folgende(n) Hoster ein:</p>
          <p className={p}>
            Vercel Inc.
            <br />
            340 S Lemon Ave
          ...
          <h4 className={h4}>Auftragsverarbeitung</h4>
          <p className={p}>
          ...
          <p className={p}>
            ...
            {' '}B. bei der Kommunikation per E-Mail) Sicherheitslücken
          ...
          <p className={p}>
            ...
            außerdem auf Grundlage von Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie
            in die Speicherung von Cookies oder in den Zugriff auf Informationen
            in Ihr Endgerät (z.{' '}B. via Device-Fingerprinting)
          ...
          <p className={p}>
            ...
            wenn der Empfänger eine Zertifizierung unter dem „EU-US Data Privacy
            Framework" (DPF) besitzt oder über geeignete zusätzliche Garantien
          ...
          <h3 className={h3}>Auskunft, Berichtigung und Löschung</h3>
          <p className={p}>
          ...
          <h3 className={h3}>Recht auf Einschränkung der Verarbeitung</h3>
          <p className={p}>
          ...
          <h3 className={h3}>Widerspruch gegen Werbe-E-Mails</h3>
          <p className={p}>
          ...
          <p className={p}>
            ...
            oder die Anzeige von Videos). Andere Cookies können zur Auswertung
          ...
          <p className={p}>
            ...
            oder zur Optimierung der Website (z.{' '}B. Cookies zur
            ...
            Grundlage dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und § 25
          ...
          <h3 className={h3}>Anfrage per E-Mail, Telefon oder Telefax</h3>
          <p className={p}>
          ...
          <h3 className={h3}>Kommunikation via WhatsApp</h3>
          <p className={p}>
            ...
            Anbieter ist die WhatsApp Ireland Limited, Merrion Road, Dublin 4,
            D04 X2K5, Irland.
          </p>
          <p className={p}>
            ...
            Kommunikationsvorgangs entstehen (z.{' '}B. Absender, Empfänger
          ...
          <p className={p}>Wir nutzen WhatsApp in der Variante „WhatsApp Business".</p>
          <p className={p}>
          ...
          <p className={p}>
            ...
            kommen. Außerdem erfassen wir verschiedene Logdateien (z.
            {' '}B. IP-Adresse, Referrer, verwendete Browser und
            Betriebssysteme) und können messen, ob unsere Websitebesucher
          ...
          <h2 className={h2}>6. Newsletter</h2>

          <h3 className={h3}>{'Newsletter­daten'}</h3>
          <p className={p}>
          ...
          <h3 className={h3}>Mailjet</h3>
          <p className={p}>
            Diese Website nutzt Mailjet für den Versand von Newslettern.
            Anbieter ist die Mailgun Technologies Inc., 112 E Pecan Sr. #1135,
          ...
          <h4 className={h4}>Datenanalyse durch Mailjet</h4>
          <p className={p}>
            Mit Hilfe von Mailjet ist es uns möglich, unsere Newsletter-Kampagnen
            zu analysieren. So können wir z.{' '}B. sehen, ob eine
            Newsletter-Nachricht geöffnet wurde und welche Links ggf. angeklickt
            wurden. Auf diese Weise können wir u.a. feststellen, welche Links
          ...
          <p className={p}>
            ...
            Wir können so z.{' '}B. erkennen, ob Sie nach dem Anklicken des
          ...
          <p className={p}>
            ...
            sich die Newsletterempfänger z.{' '}B. nach Alter, Geschlecht
            oder Wohnort unterteilen. Auf diese Weise lassen sich die Newsletter
            besser an die jeweiligen Zielgruppen anpassen. Wenn Sie keine
            Analyse durch Mailjet wollen, müssen Sie den Newsletter abbestellen.
            Hierfür stellen wir in jeder Newsletternachricht einen entsprechenden
            Link zur Verfügung.
          </p>
          <p className={p}>
          ...
          <h4 className={h4}>Rechtsgrundlage</h4>
          <p className={p}>
          ...
          <p className={p}>
            ...
            der EU-Kommission gestützt. Details finden Sie hier:{' '}
            <a
              href="https://www.mailjet.de/av-vertrag/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <h4 className={h4}>Speicherdauer</h4>
          <p className={p}>
          ...
          <h2 className={h2}>7. Eigene Dienste</h2>

          <h3 className={h3}>Umgang mit Bewerberdaten</h3>
          <p className={p}>
            Wir bieten Ihnen die Möglichkeit, sich bei uns zu bewerben (z.
            {' '}B. per E-Mail, postalisch oder via
            Online-Bewerberformular). Im Folgenden informieren wir Sie über
            Umfang, Zweck und Verwendung Ihrer im Rahmen des Bewerbungsprozesses
            erhobenen personenbezogenen Daten. Wir versichern, dass die
            Erhebung, Verarbeitung und Nutzung Ihrer Daten in Übereinstimmung
          ...
          <p className={p}>
            ...
            damit verbundenen personenbezogenen Daten (z.{' '}B. Kontakt-
            und Kommunikationsdaten, Bewerbungsunterlagen, Notizen im Rahmen von
          ...
          <p className={p}>
            Im Rahmen des Bewerbungsverfahrens führen wir unter Umständen auch
            eine Internetrecherche Ihrer Person durch. Dies umfasst vor allem
            die Google-Suche, Linkedin und Xing. Rechtsgrundlage für diese Art
            der Verarbeitung ist unser berechtigtes Interesse uns ein
            Gesamteindruck von öffentlich zugänglichen Informationen gemäß Art.
            6 Abs. 1 lit. f DSGVO über Sie zu verschaffen.
          </p>
          ...
          <h4 className={h4}>Aufnahme in den Bewerber-Pool</h4>
          <p className={p}>
